<div class="card_wrapper">
  ...
  <div class="the_details text-center">
    <h2 class="fw-bold text_head text_black text-center">بطولة ملك
    </h2>
    <!-- <div class="my-1 text-center">
          <p class="gold">تاريخ النشر: 01-01-1999</p>
        </div> -->
    <p class="text_details text_clamb text-color-black text-center">
      سلسلة مكونة من احدي عشرة قصة متسلسلة تحكي حكاية بطولة و ملحمة فتوة    </p>
