...
@includeFirst(['admin.layout.header'])
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">قائمه البحوث</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="p-2">
                <a href="researches/create" class="btn btn-success">
                    <i class="fa fa-plus"></i> انشاء بحث
                </a>
            </div>
            <div class="container-fluid">
                <div class="row">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @forelse($rows as $row)
                                        <tr>
                                            ...
                                            <td>{{ Str::limit($row->research_content, 10) }}</td>
                                            <td>{{$row->image}}</td>
                                            <td class="text-center">
                                                ...
                                                @if(request('deleted') != 'yes')
                                                    ...
                                                    <form  class="d-inline" method="POST" title="حذف" action="{{route('researches.delete' , $row->uuid)}}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
