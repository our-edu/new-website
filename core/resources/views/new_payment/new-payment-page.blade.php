        ...
        <form method="post" action="{{$url}}">
            ...
            <div class="card-body">
                <div class="card-item border-bottom-grey">
                    <div class="card-item_content">{{$parentDue->balance}}</div>

                    <div class="card-item_title">{{__('payment.required balance',[],$language)}}</div>
                </div>
                ...
                <div class="card-item border-bottom-grey">
                    ...
                    <div class="card-item_title">{{__('payment.parent_email',[],$language)}}</div>
                </div>
                <div class="card-item border-bottom-grey">
                ...
                <div class="total">
                    <div class="header">
                        ...
                        <div class="card-item_title">{{__('payment.full_total_balance',[],$language)}}</div>
                    </div>
