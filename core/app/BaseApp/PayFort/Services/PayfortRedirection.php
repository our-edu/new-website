...
namespace App\BaseApp\PayFort\Services;

use App\BaseApp\PayFort\Traits\PayfortRedirectRequest;
...
class PayfortRedirection extends Payfort
{
    ...
    public function __construct($config)
    {
        ...
        $this->config['return_url'] = setLocaleForProduction($this->config['return_url']);
    }
}
